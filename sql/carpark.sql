...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2017 at 11:45 AM
...
(1, 'hour1', 'hours', 300, 1),
(2, 'sub30days', 'subscription', 5000, 30),
(3, 'sub90days', 'subscription', 12000, 90),
(4, 'sub180days', 'subscription', 22000, 180),
(5, 'sub1year', 'subscription', 40000, 366);
...
--
ALTER TABLE `ticket`
  MODIFY `TicketNo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
